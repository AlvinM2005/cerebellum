...
def practice3_1(screen):
    return run_trials(practice3_1_trials, SM_RESPONSE_TIME, SM_ISI_TIME, "sensorimotor", screen)

def practice3_2(screen):
    return run_trials(practice3_2_trials, SM_RESPONSE_TIME, SM_ISI_TIME, "sensorimotor", screen)

def block3(screen):
    return run_trials(block3_trials, SM_RESPONSE_TIME, SM_ISI_TIME, "sensorimotor", screen)
