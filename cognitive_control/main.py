...
def run_sensorimotor():
    run_segment6(screen, all_results, all_acc, lambda:
        run_segment8(screen, all_results, all_acc, lambda: end_and_save())
    )

def run_motor():
    run_segment1(screen, all_results, all_acc, lambda:
        run_segment3(screen, all_results, all_acc, lambda:
            run_segment5(screen, all_results, all_acc, lambda: run_sensorimotor())
        )
    )
