...
INSTRUCTION_COUNT = 38  # instruction count

# 0-back
PRACTICE1 = 6   # Practice 1 (10 trials) begins after page ~
BLOCK1 = 9      # Block 1 (20 trials) begins after page ~
BLOCK2 = 12     # Block 2 (20 trials) begins after page ~

# 1-back
PRACTICE2 = 18  # Practice 2 (10 trials) begins after page ~
BLOCK3 = 21     # Block 3 (20 trials) begins after page ~
BLOCK4 = 24     # Block 4 (20 trials) begins after page ~

# 2-back
PRACTICE3 = 31  # Pracitice 3 (10 trials) begins after page ~
BLOCK5 = 34     # Block 5 (20 trials) begins after page ~
BLOCK6 = 37     # Block 6 (20 trials) begins after page ~
...
if MODE == "test":
    ...
    BLOCK1_COUNT, BLOCK2_COUNT, BLOCK3_COUNT, BLOCK4_COUNT, BLOCK5_COUNT, BLOCK6_COUNT = (3, 3, 3, 3, 3, 3)
...
# actual mode
    ...
    BLOCK1_COUNT, BLOCK2_COUNT, BLOCK3_COUNT, BLOCK4_COUNT, BLOCK5_COUNT, BLOCK6_COUNT = (20, 20, 20, 20, 20, 20)
