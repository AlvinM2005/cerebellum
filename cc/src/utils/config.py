...
# MODE = "actual"   # real participant runs
...
LAST_INSTRUCTION_AUTO_EXIT_ACTUAL_MS = 10000
if MODE == "demo":
    LAST_INSTRUCTION_AUTO_EXIT_MS = LAST_INSTRUCTION_AUTO_EXIT_DEMO_MS
else:
    LAST_INSTRUCTION_AUTO_EXIT_MS = LAST_INSTRUCTION_AUTO_EXIT_ACTUAL_MS
...
# ---------- Trial Counts [Contextual] ----------

if MODE == "demo":
    PRACTICE4_1_NUM_ACTUAL = 2
    PRACTICE4_1_NUM_NOGO = 0

    PRACTICE4_2_NUM_ACTUAL = 2
    PRACTICE4_2_NUM_NOGO = 0

    C_SINGLE_BLOCK1_NUM_ACTUAL = 0
    C_SINGLE_BLOCK1_NUM_NOGO = 0
    C_SINGLE_BLOCK2_NUM_ACTUAL = 0
    C_SINGLE_BLOCK2_NUM_NOGO = 0

    C_MIXED_PRACTICE_NUM_ACTUAL = 0
    C_MIXED_PRACTICE_NUM_NOGO = 0
    ...
    PRACTICE4_1_NUM_ACTUAL = 24
    PRACTICE4_1_NUM_NOGO = 0

    PRACTICE4_2_NUM_ACTUAL = 24
    PRACTICE4_2_NUM_NOGO = 0
    ...
    BLOCK5_NUM_ACTUAL = 48
    BLOCK5_NUM_NOGO = 0

    BLOCK6_NUM_ACTUAL = 48
    BLOCK6_NUM_NOGO = 0
...
C_SINGLE_BLOCK1_PAGE = 15 # Single-task block 1 begins after page ~
C_SINGLE_BLOCK2_PAGE = 16 # Single-task block 2 begins after page ~
C_MIXED_PRACTICE_PAGE = 17 # Mixed-task practice begins after page ~
BLOCK5_PAGE = 18 # Block 5 begins after page ~
