...
class FeedbackIcon:
    def __init__(self):
        ...
        try:
            # Define icon paths using absolute paths with correct file extensions
            ...
            self.correct_icon = pygame.transform.scale(correct_image, (100, 100))

            incorrect_image = pygame.image.load(incorrect_icon_path)
            self.incorrect_icon = pygame.transform.scale(incorrect_image, (100, 100))

            timeout_image = pygame.image.load(timeout_icon_path)
            self.timeout_icon = pygame.transform.scale(timeout_image, (300, 300))
            ...
            self.correct_icon = pygame.Surface((100, 100))
            self.correct_icon.fill((0, 255, 0))  # Green for correct
            
            self.incorrect_icon = pygame.Surface((100, 100))
            self.incorrect_icon.fill((255, 0, 0))  # Red for incorrect
            
            self.timeout_icon = pygame.Surface((300, 300))
