...
def _make_trial(color: str, case_type: str, stimuli: str) -> TrialSpec:
    return {
        "color": color,
        "case_type": case_type,
        "stimuli": stimuli,
...
MULTI_TASK_PRACTICE: list[TrialSpec] = [
    _make_trial("pink", "lower", "a"),
    _make_trial("pink", "upper", "B"),
    _make_trial("yellow", "lower", "a"),
    _make_trial("yellow", "upper", "G"),
    _make_trial("pink", "upper", "E"),
    _make_trial("pink", "lower", "r"),
    _make_trial("yellow", "lower", "e"),
    _make_trial("yellow", "upper", "I"),
    _make_trial("pink", "lower", "u"),
    _make_trial("yellow", "lower", "p"),
]

MULTI_TASK_EXPERIMENTAL_BLOCK_1: list[TrialSpec] = [
    _make_trial("yellow", "upper", "I"),
    _make_trial("yellow", "lower", "a"),
    _make_trial("pink", "upper", "U"),
    _make_trial("pink", "lower", "e"),
    _make_trial("pink", "upper", "R"),
    _make_trial("pink", "upper", "I"),
    _make_trial("pink", "upper", "G"),
    _make_trial("yellow", "lower", "p"),
    _make_trial("yellow", "upper", "P"),
    _make_trial("yellow", "lower", "a"),
    _make_trial("yellow", "lower", "u"),
    _make_trial("yellow", "lower", "r"),
    _make_trial("pink", "upper", "B"),
    _make_trial("yellow", "lower", "e"),
    _make_trial("yellow", "lower", "g"),
    _make_trial("yellow", "upper", "B"),
    _make_trial("yellow", "lower", "r"),
    _make_trial("pink", "lower", "e"),
    _make_trial("pink", "upper", "E"),
    _make_trial("pink", "upper", "A"),
    _make_trial("yellow", "lower", "i"),
    _make_trial("yellow", "upper", "U"),
    _make_trial("pink", "lower", "i"),
    _make_trial("yellow", "upper", "A"),
    _make_trial("pink", "upper", "U"),
    _make_trial("yellow", "upper", "E"),
    _make_trial("pink", "lower", "a"),
    _make_trial("pink", "lower", "u"),
    _make_trial("pink", "lower", "i"),
    _make_trial("yellow", "upper", "P"),
    _make_trial("yellow", "upper", "U"),
    _make_trial("pink", "upper", "R"),
    _make_trial("yellow", "upper", "R"),
    _make_trial("yellow", "upper", "B"),
    _make_trial("pink", "upper", "P"),
    _make_trial("pink", "upper", "B"),
    _make_trial("yellow", "upper", "G"),
    _make_trial("pink", "lower", "b"),
    _make_trial("yellow", "upper", "I"),
    _make_trial("pink", "lower", "g"),
    _make_trial("pink", "lower", "g"),
    _make_trial("yellow", "lower", "e"),
    _make_trial("pink", "lower", "p"),
    _make_trial("yellow", "lower", "g"),
    _make_trial("pink", "upper", "A"),
    _make_trial("pink", "lower", "r"),
    _make_trial("pink", "lower", "p"),
    _make_trial("yellow", "lower", "b"),
]
