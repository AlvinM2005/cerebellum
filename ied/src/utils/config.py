...
# ---------- Default ----------
# Select "demo" mode for testing purposes, "actual" mode for deployment
MODE = "demo"
# MODE = "actual"
...
VERSION: int | None = 1             # single version only (no VERSION grouping)
...
if MODE == "demo":
    ...
    FINAL_INSTRUCTION_TIMEOUT_MS = 2000
else:
