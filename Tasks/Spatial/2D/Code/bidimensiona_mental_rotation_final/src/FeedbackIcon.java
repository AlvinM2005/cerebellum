...
public class FeedbackIcon {
    private static final String correctIconPath = "./src/feedback_icons/Correct.jpg";
    private static final String incorrectIconPath = "./src/feedback_icons/Incorrect.jpg";
    private static final String timeoutIconPath = "./src/feedback_icons/Timeout.jpg";
